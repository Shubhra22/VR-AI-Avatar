...
namespace IBM.Watson.DeveloperCloud.Services.Assistant.v2
{
    public class Assistant : IWatsonService
    {
        ...
        public bool Message(SuccessCallback<MessageResponse> successCallback, FailCallback failCallback,
            string assistantId, string sessionId, MessageRequest request = null,
